...
import { generateEIRPDF, type EIRData } from '@/lib/eirPdfGenerator';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const portalActor = await requirePortalAction(request, db, 'portal.eir.download');
    ...
    const pdfBuffer = generateEIRPDF({
      ...(sanitizedPayload.eir as unknown as EIRData),
