...
const tabs = [
  ...
  { id: 'document-templates', group: 'customer_finance', label: 'Document Templates', description: 'จัดการ template พิมพ์เอกสารและ continuous form', keywords: 'document template continuous print tax invoice receipt', icon: <Files size={18} />, color: '#2563EB', permission: 'settings.manage' },
