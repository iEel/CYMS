...
async function update() {
  ...
  try {
    ...
    const updates = [
      ...
      // Cleaning codes
      ['CL01', 'ภายในตู้',         'สกปรก/ปนเปื้อน',         'ล้างมาตรฐาน'],
      ['CL02', 'ภายในตู้',         'สารเคมีตกค้าง',          'ล้างด้วยสารเคมี'],
      ['CL03', 'ภายในตู้',         'เศษอาหารตกค้าง',         'อบไอน้ำ+ฆ่าเชื้อ'],
      ['CL04', 'ภายนอกตู้',        'สกปรก/มีรอยเปื้อน',      'ฉีดล้างแรงดันสูง'],
      ['CL05', 'ภายในตู้',         'มีกลิ่น',                'ดับกลิ่น (Deodorize)'],
    ];
