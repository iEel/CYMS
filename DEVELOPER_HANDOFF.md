...
| **เฟส 8** | บัญชี Billing, Tariff, Hold/Release, **Tiered Storage Rates, Gate-Out Billing, Gate-In Billing, A4 Invoice/Receipt Print** | ✅ เสร็จ |
...
│   │   │   ├── billing/page.tsx  # หน้าบัญชี (7 tabs: ใบแจ้งหนี้/สร้างบิล/Tariff/Hold/เอกสาร/ERP/รายงาน)
│   │   │   └── settings/
