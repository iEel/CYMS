...
│   │   │       ├── EDIConfiguration.tsx   # SFTP/FTP/API/**Email** endpoints — CRUD + **⏰ Auto-Schedule UI** + **📋 Template Editor** (2-tab layout, field mapping, live preview)
...
- [x] **📋 EDI Template System** — template-based format per shipping line: field mapping, custom headers, date format, CSV delimiter, EDIFACT version — Config ผ่าน UI ไม่ต้องแก้โค้ด
