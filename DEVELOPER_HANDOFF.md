...
> ส่งมอบงาน: 19 มีนาคม 2569 | เวอร์ชัน: เฟส 1-9 + FR1-6 + NFR + Master Setup + Customer Management (96%)
...
│   │       ├── settings/
│   │       │   ├── company/route.ts        # GET/POST company profile (+ branch + logo NVARCHAR(MAX))
...
- **Company Profile**: CRUD → DB + **logo upload (base64 NVARCHAR(MAX))** + **สาขา (สำนักงานใหญ่/สาขาที่)**
