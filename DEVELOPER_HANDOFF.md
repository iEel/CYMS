...
- **Remaining API hardening queue**: static scan หลัง slice นี้เหลือ mutation route ที่ยังต้อง harden ต่อ ได้แก่ `bookings/containers`, กลุ่ม `edi/*`, `mnr/cedex`, `operations/shift`, `settings/photo-retention/cleanup`, และ `yard/audit`
