...
- [x] **EIR In/Out actions** — Container inventory แสดงเอกสาร `EIR In` และ `EIR Out` แยกกัน ถ้ามีทั้งขาเข้า/ขาออก พร้อมปุ่ม `ดู` และ `ผลตรวจ`; ถอดปุ่ม PDF ออกจากหน้า Containers
...
# 🧪 รัน Tests ทั้งหมด (ล่าสุด 430/430 tests ผ่าน)
npm test
