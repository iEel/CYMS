...
| `GateTransactions` | container_id, transaction_type, driver_name, truck_plate, eir_number, **container_owner_id** (FK→Customers), **billing_customer_id** (FK→Customers) | บันทึก Gate In/Out — **แยกเจ้าของตู้/คนจ่ายเงิน** |
