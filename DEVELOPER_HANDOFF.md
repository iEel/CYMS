...
| **เฟส 6** | เชื่อมโยง EDI สายเรือ | ❌ ยังไม่เริ่ม |
| **เฟส 7** | ซ่อมบำรุง M&R, EOR | ❌ ยังไม่เริ่ม |
| **เฟส 8** | บัญชีการเงิน, Billing | ❌ ยังไม่เริ่ม |
| **เฟส 9** | Offline-First, PWA, ปรับแต่ง | ❌ ยังไม่เริ่ม |
...
### เฟส 6: เชื่อมโยง EDI สายเรือ
- [ ] Customer Master + EDI Config + ISO Codes
- [ ] นำเข้า Booking/Manifest
- [ ] Seal Cross-Validation

### เฟส 7: ซ่อมบำรุง M&R
- [ ] ใบ EOR จาก CEDEX codes
- [ ] ระบบอนุมัติ EOR

### เฟส 8: บัญชีการเงิน
- [ ] Auto-Billing (Storage, LOLO, M&R, Washing/PTI)
- [ ] Hold/Release workflow
- [ ] ใบวางบิล, ใบแจ้งหนี้, ใบเสร็จ, ใบลดหนี้

### เฟส 9: ปรับแต่ง
- [ ] Offline-First (IndexedDB + Auto-Sync)
- [ ] PWA optimization
- [ ] UI Components (Modal, Toast, Tooltip, Table pagination)
